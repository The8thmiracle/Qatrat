...
class ReviewPreview extends StatefulWidget {
  ...
  const ReviewPreview({super.key, this.index, this.productModel, this.imageList});
  @override
    ...
    return Scaffold(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          if (widget.productModel != null) Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (model!.comment != null && model!.comment!.isNotEmpty) SizedBox(
