...
String getThemeColor(BuildContext context) {
  ...
  if (systemBrightness == Brightness.dark && applicationBrightness == Brightness.light) {
    return 'assets/images/logo.PNG';
  } else if (systemBrightness == Brightness.light && applicationBrightness == Brightness.light) {
    return 'assets/images/logo.PNG';
  } else {
    return 'assets/images/logo.PNG';
  }
