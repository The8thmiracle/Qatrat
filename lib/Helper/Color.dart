...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff26897E);

  static const Color secondary = Color(0xff1EBAAA);

  static const darkprimary = Color(0xff247B88);

  static const darksecondary = Color(0xff1EBAAA);
