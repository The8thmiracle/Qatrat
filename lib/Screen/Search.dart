  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          titleSpacing: 0,
          actions: [
            if (_controller.text != "") IconButton(
                    onPressed: () {
                      _controller.text = '';
                    },
                    icon: Icon(
        ...
        child: InkWell(
          ...
          child: Stack(
            children: [
                          ...
                          children: <Widget>[
                            ...
                            if (model.prVarientList![model.selVarient!].attr_name !=
                                    ...
                                    model.prVarientList![model.selVarient!]
                                        .attr_name!.isNotEmpty) ListView.builder(
                                    physics:
                            ...
                            Row(
                              children: [
                                ...
                                const Spacer(),
                                if (model.availability == "0") const SizedBox.shrink() else cartBtnList
                                        ? Row(
                                            children: <Widget>[
                                              Row(
                                                children: <Widget>[
              ...
              if (productList[index].availability == "0") Text(getTranslated(context, 'OUT_OF_STOCK_LBL')!,
                      style: Theme.of(context).textTheme.titleSmall!.copyWith(
                          color: Colors.red, fontWeight: FontWeight.bold,),) else const SizedBox.shrink(),
            ],
          ),
        ),
      ),
      ...
      try {
        if (notificationisloadmore) {
          ...
          apiBaseHelper.postAPICall(getProductApi, parameter).then((getdata) {
            ...
            final String? search = getdata['search'];
      ...
      return notificationisnodata
          ...
          : Column(
              children: <Widget>[
                ...
                if (notificationisgettingdata) Padding(
                        padding:
    ...
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int i) {
        ...
        return ListTile(
            ...
            subtitle: textController!.text.trim().isEmpty ||
                    suggestion.history!
                ? null
                : Text(
            ...
            leading: textController!.text.trim().isEmpty ||
                    suggestion.history!
            ...
            onTap: () async {
              if (suggestion.name!.startsWith('Search Result for ')) {
                ...
                settingsProvider.setPrefrenceList(
                    HISTORYLIST, textController!.text.trim(),);
                buildResult = false;
                clearAll!();
                getProduct!();
